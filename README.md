...
I first implemented the GraphQL API in this [commit](https://github.com/Fifirex/FifiGit/commit/5b8a0b608be2248e60d6bd7798f00ac2e07ca678). At the same time saving fundamentals used in the previous state were carried forward in the current module.
